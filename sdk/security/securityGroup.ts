...
export class SecurityGroup extends pulumi.CustomResource {
    ...
    /** @internal */
    public static readonly __pulumiType = 'tsb:security/securityGroup:SecurityGroup';
     ...
     */
    declare public readonly namespaceSelector: pulumi.Output<outputs.security.SecurityGroupNamespaceSelector>;
    /**
...
export interface SecurityGroupState {
     ...
     * Set of namespaces owned exclusively by this group. Use `*&#47;*` to claim all cluster resources under the workspace.
     */
    namespaceSelector?: pulumi.Input<inputs.security.SecurityGroupNamespaceSelector | undefined>;
    /**
     * The parent id for the Group resource.
     */
...
export interface SecurityGroupArgs {
     ...
     * Set of namespaces owned exclusively by this group. Use `*&#47;*` to claim all cluster resources under the workspace.
     */
    namespaceSelector: pulumi.Input<inputs.security.SecurityGroupNamespaceSelector>;
    /**
     * The parent id for the Group resource.
     */
